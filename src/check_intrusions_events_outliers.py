...
# Calculate the total number of items less than 0
count_negative_values = df_clean[df_clean["duration_seconds"] < 0].shape[0]
print("Number of items less than zero:", count_negative_values)

# Seleziona le righe con valori minori di zero nella colonna di interesse
df_minori_zero = df_clean[df_clean["duration_seconds"] < 0][
    [
        "codiceutente",
        "periferica",
        "Ragione Sociale",
...
# writing dataframe with date/time information
df_clean.to_excel(
    "P:/Lavoro/VSCode/New_project/demo-project/data/settembre_2024_intr_no_filter.xlsx",
    index=False,
)
df_minori_zero.to_excel(
    "P:/Lavoro/VSCode/New_project/demo-project/data/settembre_2024_less_0.xlsx",
    index=False,
)
